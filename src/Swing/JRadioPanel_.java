...
class JTabbedPaneFrame extends JFrame{
	...
	JTabbedPaneFrame(){
		...
		JRadioPanel tap1 = new JRadioPanel(); // 첫번째 탭 객체 생성
		JComboBoxPanel tap2 = new JComboBoxPanel();  // 두번째 탭 객체 생성
		
		JTabbedPane jtp = new JTabbedPane(); // 탭객체 생성
